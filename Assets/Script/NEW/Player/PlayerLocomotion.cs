...
namespace SG
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        [SerializeField] float groundDetecitonRayStartPoint = 0.5f;
        ...
        void Start()
        {
            cameraObjet = Camera.main.transform;
        ...
        public void HandleRotation(float delta)
        {
            if (animatorHandler.canRotate)
            {
                ...
                else
                {
                    ...
                    targetDir = cameraObjet.forward * inputHandler.vertical;
                    targetDir += cameraObjet.right * inputHandler.horizontal;
        ...
        public void HandleMovement(float delta)
        {
            ...
            moveDirection = cameraObjet.forward * inputHandler.vertical;
            moveDirection += cameraObjet.right * inputHandler.horizontal;
        ...
        public void HandleFalling(float delta, Vector3 moveDirection)
        {
            ...
            origin.y += groundDetecitonRayStartPoint;
